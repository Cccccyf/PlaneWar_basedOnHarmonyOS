...
public class MiddleSprite extends Sprite{
    public int my_score = 50;
    public MiddleSprite(PixelMap bitmap, int screenWidth, int screenHeight) {
        super(bitmap, screenWidth, screenHeight);
        float ori = (float) Math.random();
        this.rect.left = (float) ((screenWidth - 200) * ori);
        this.rect.right = (float) (this.rect.left + 150);
